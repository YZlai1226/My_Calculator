...
def main() -> None:
    ...
    tk.Button(window, text=" 0 ", width='5', height='1', command=lambda:
              my_calc.input_key("0")).grid(row=6, column=0)
    tk.Button(window, text=" 1 ", width='5', height='1', command=lambda:
              my_calc.input_key("1")).grid(row=5, column=0)
    tk.Button(window, text=" 2 ", width='5', height='1', command=lambda:
              my_calc.input_key("2")).grid(row=5, column=1)
    tk.Button(window, text=" 3 ", width='5', height='1', command=lambda:
              my_calc.input_key("3")).grid(row=5, column=2)
    tk.Button(window, text=" 4 ", width='5', height='1', command=lambda:
              my_calc.input_key("4")).grid(row=4, column=0)
    tk.Button(window, text=" 5 ", width='5', height='1', command=lambda:
              my_calc.input_key("5")).grid(row=4, column=1)
    tk.Button(window, text=" 6 ", width='5', height='1', command=lambda:
              my_calc.input_key("6")).grid(row=4, column=2)
    tk.Button(window, text=" 7 ", width='5', height='1', command=lambda:
              my_calc.input_key("7")).grid(row=3, column=0)
    tk.Button(window, text=" 8 ", width='5', height='1', command=lambda:
              my_calc.input_key("8")).grid(row=3, column=1)
    ...
    tk.Button(window, text=" ) ", width='5', height='1', command=lambda:
              my_calc.input_key(")")).grid(row=7, column=2)
    tk.Button(window, text=" + ", width='5', height='1', command=lambda:
              my_calc.input_key("+")).grid(row=3, column=3)
    tk.Button(window, text=" - ", width='5', height='1', command=lambda:
              my_calc.input_key("-")).grid(row=4, column=3)
    tk.Button(window, text=" * ", width='5', height='1', command=lambda:
              my_calc.input_key("*")).grid(row=5, column=3)
    tk.Button(window, text=" / ", width='5', height='1', command=lambda:
              my_calc.input_key("/")).grid(row=6, column=3)
    tk.Button(window, text=" ^ ", width='5', height='1', command=lambda:
